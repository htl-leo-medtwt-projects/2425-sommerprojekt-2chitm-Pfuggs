...
var map = L.map('postMap', {attributionControl: false, zoomControl: false, dragging: false, scrollWheelZoom: false, doubleClickZoom: false, touchZoom: false}).setView([spot.lat, spot.lon], 19);
...
function addComment(event) {
    ...
    spot = allSpots[index];
    spot.comments[spot.comments.length] = document.getElementById("commentInput").value;
